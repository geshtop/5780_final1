...
namespace DS
{
    public class Hosts
    {
        public static List<Host> getHosts()
        {
            ...
            hosts.Add(new Host() { Id=1, FirstName = "אריה", LastName = "דהאן", PhonePre = "052", PhoneExt = "4564444", HostKey = "012456790", MailAddress = "1@nomail.com", Password="1111",  BankNumber=12, BranchNumber=558, BankAccount=123556 });
            hosts.Add(new Host() { Id = 2, FirstName = "מאיר", LastName = "כהן", PhonePre = "054", PhoneExt = "4564444", HostKey = "001222567", MailAddress = "2@nomail.com", Password = "1111" });
